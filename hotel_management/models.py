...
class LoadDashboard(models.Model): 
    ...
    no_of_bags = models.IntegerField(blank=True, null=True)
    weight = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)
    actual_no_of_bags = models.IntegerField(blank=True, null=True)
    actual_weight = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)
    green_point_hotel = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)
    green_point_recycler = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)
