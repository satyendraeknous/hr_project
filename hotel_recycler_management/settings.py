"""
Django settings for hotel_recycler_management project.
...
SECRET_KEY = 'icpm&41j4(_1p-ts3wahi#jhb8&bid2vu@v=ka!2q!y0_5z&d*'
...
ROOT_URLCONF = 'hotel_recycler_management.urls'
...
WSGI_APPLICATION = 'hotel_recycler_management.wsgi.application'
